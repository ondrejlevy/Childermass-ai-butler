...
def get_credentials_path() -> Path:
    ...
    return Path(
        os.getenv(
            "CONTACTS_CREDENTIALS_PATH", str(DEFAULT_CREDENTIALS_PATH)
        )
    )
...
def authenticate(account: str | None = None) -> None:
    ...
    if not credentials_path.exists():
        ...
        print("\nTo set up Google People API access:")
        print("1. Go to https://console.cloud.google.com/")
        print("2. Create a project and enable People API")
    ...
    print("You can now use the Contacts MCP server.\n")
